            ...
            <div className="relative" ref={profileRef}>
              ...
              {profileDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-44 bg-white border border-borderLight rounded-xl shadow-xl py-1.5 z-50 animate-fadeIn">
                  ...
                  <button className="w-full text-left px-4 py-2.5 text-xs font-semibold text-primary hover:bg-orange-50 transition-colors" onClick={() => setProfileDropdownOpen(false)}>
                    Sign Out
                  </button>
                </div>
              )}
